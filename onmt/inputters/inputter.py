...
def filter_example(ex, use_src_len=True, use_tgt_len=True, use_history_len=False,
    ...
    return (not use_src_len or min_src_len <= src_len <= max_src_len) and \
        ...
        (not use_history_len or min_history_len <= history_len <= max_history_len)
...
def _merge_field_vocabs(src_field, history_field, ans_field, tgt_field, vocab_size, min_freq,
                        vocab_size_multiple):
